...
<form id="formButton" action="index.php" method="post">
<input type ="submit" name ="accueilBouton" class ="boutonHome" value="Accueil">
</form>
<form id="formButton" action="deconnexion.php" method="post">
<input type="submit" name="deconnexionBouton" class="boutonDeconnexion" value="Déconnexion">
</form>
<div>
